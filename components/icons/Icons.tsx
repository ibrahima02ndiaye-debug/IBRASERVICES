...
export const CarIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <path d="M14 16.5V15a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v1.5M4 11l-1-5h18l-1 5M2 11h20M2 16.5h20M6 11V7M18 11V7"></path>
  </svg>
);
...
export const GarageIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M22 10v10h-2V12h-2v8h-2V12h-2v8h-2V12H8v8H6V12H4v8H2v-6l10-4 10 4z"/>
        <path d="M2 10V8l10-4 10 4v2"/>
        <path d="M12 18h.01"/>
    </svg>
);
...
export const BotIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        ...
        <path d="M16.5 7.5a2.5 2.5 0 0 0-5 0"/>
    </svg>
);
...
export const CloudIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M17.5 19c0-3.037-2.463-5.5-5.5-5.5S6.5 15.963 6.5 19H2v-2a6 6 0 0 1 6-6h8a6 6 0 0 1 6 6v2h-4.5z"/>
        <path d="M18 10a6 6 0 0 0-9.33-5 9 9 0 0 0-2.46 8.7"/>
    </svg>
);