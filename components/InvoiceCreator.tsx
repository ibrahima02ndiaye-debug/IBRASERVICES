...
const InvoiceCreator: React.FC<InvoiceCreatorProps> = ({ clients, onCancel }) => {
    ...
    const handleGenerate = () => {
        ...
        // Simple invoice generation using print dialog
          ...
          <html>
            <head>
              ...
              <style>
                ...
                .header { display: flex; justify-between; margin-bottom: 30px; }
            ...
            <body>
              <div class="header">
                <div>
                  <div class="company">IBRA Services</div>
                  <div>2374 Rue Royale, Trois-Rivières</div>
                  <div>(819) 979-1017</div>
                </div>
                <div style="text-align: right;">
                  <div>FACTURE</div>
                  <div style="font-weight: bold;">#${invoiceNumber}</div>
                </div>
              </div>
              ...
              <button onclick="window.print()" style="margin-top: 30px; padding: 10px 20px; background: #3b82f6; color: white; border: none; cursor: pointer;">
                            ...
                            <div className="flex gap-2">
                                {['modern', 'classic', 'minimal'].map((tmpl) => (
                                    <button
                                        ...
                                        className={`flex-1 py-1.5 text-xs font-semibold rounded-md border transition-all ${template === tmpl
